# 실시간 STT 기반 일본어 번역 시스템 실행 가이드

이 프로젝트는 마이크 입력을 실시간으로 음성 인식한 뒤, 문장을 정제하고 로컬 LLM을 통해 일본어 번역 결과를 제공하는 시스템입니다.  
Flask 백엔드 서버, STT 노드, LM Studio 로컬 서버를 함께 실행하여 사용할 수 있습니다.
